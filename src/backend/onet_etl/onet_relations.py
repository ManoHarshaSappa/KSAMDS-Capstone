...
class ONetRelationshipBuilder:
    ...
    def __init__(
        ...
        self.input_dir = self.project_root / "data" / "onet" / "archive" / "mapped"
        self.output_dir = self.project_root / "data" / \
            "onet" / "archive" / "relationships"
        self.cache_dir = self.project_root / "data" / "onet" / "archive" / "embeddings"
        self.reports_dir = self.project_root / "data" / "onet" / "reports"
