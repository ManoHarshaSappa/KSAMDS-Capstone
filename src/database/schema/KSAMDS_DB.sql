...
CREATE TABLE IF NOT EXISTS ksamds.certification (
  ...
  UNIQUE(issuer, name)                -- Certification is unique per issuer
);
...
-- =========================
-- FIXED: Added level_id to track specific level requirements per occupation
...
CREATE TABLE IF NOT EXISTS ksamds.occupation_certification (
  ...
  is_required BOOLEAN DEFAULT false,              -- Is this certification required vs. preferred?
